...
void Mackity::processReplacing(float **inputs, float **outputs,
  ...
  // inTrim *= inTrim;
  double inTrim =
      pow(10.0, A * 2.0); // 0.0 -> 1.0 (Unity), 1.0 -> 100.0 (+40dB)
  ...
  while (--sampleFrames >= 0) {
    ...
    if (fabs(iirSampleAL) < 1.18e-37)
      iirSampleAL = 0.0;
    iirSampleAL =
        (iirSampleAL * (1.0 - iirAmountA)) + (inputSampleL * iirAmountA);
    inputSampleL -= iirSampleAL;
    if (fabs(iirSampleAR) < 1.18e-37)
      iirSampleAR = 0.0;
    iirSampleAR =
        (iirSampleAR * (1.0 - iirAmountA)) + (inputSampleR * iirAmountA);
    ...
    double outSampleL = inputSampleL; // BYPASS FILTER A
    ...
    double outSampleR = inputSampleR; // BYPASS FILTER A
    ...
    outSampleL = inputSampleL; // BYPASS FILTER B
    ...
    outSampleR = inputSampleR; // BYPASS FILTER B
    ...
    if (fabs(iirSampleBL) < 1.18e-37)
      iirSampleBL = 0.0;
    iirSampleBL =
        (iirSampleBL * (1.0 - iirAmountB)) + (inputSampleL * iirAmountB);
    inputSampleL -= iirSampleBL;
    if (fabs(iirSampleBR) < 1.18e-37)
      iirSampleBR = 0.0;
    iirSampleBR =
        (iirSampleBR * (1.0 - iirAmountB)) + (inputSampleR * iirAmountB);
...
void Mackity::processDoubleReplacing(double **inputs, double **outputs,
                                     VstInt32 sampleFrames) {
  double *in1 = inputs[0];
  double *in2 = inputs[1];
